...
(set-face-background 'highlight-indent-face "#222")
;(set-face-background 'highlight-indent-current-column-face "#444444")

(add-hook 'python-mode-hook 'highlight-indentation)
(add-hook 'clevercss-mode-hook 'highlight-indentation)
