  ...
  (color-theme-install
   '(color-theme-wombat
     ...
     ((apropos-keybinding-face . underline)
      ...
      (list-matching-lines-fbuffer-name-face . underline)
      (list-matching-lines-face . match)
      (view-highlight-face . highlight)
      (widget-mouse-face . highlight))
     (default ((t (:stipple nil :background "#000000" :foreground "#f6f3e8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "outline" :family "Courier New"))))
     ...
     (completions-common-part ((t (:family "Courier New" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#f6f3e8" :background "#000000" :stipple nil :height 98))))
     ...
     (dired-perm-write ((t (:family "Courier New" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#f6f3e8" :background "#000000" :stipple nil :height 98))))
